...
export function renderHeader(p) {
  ...
  return `
    <div class="header">
      ...
      <div class="class-badge" style="margin-top:8px">${p.class} · ${p.subClass}</div>
      ...
      <div class="rank-row">
        ...
        <div class="rcell">
          ...
          <div class="rico" style="font-family:'Cinzel',serif;font-size:20px;font-weight:900;color:var(--gold)">${p.level}</div>
        ...
        <div class="rcell">
          ...
          <div class="rico" style="font-family:'Cinzel',serif;font-size:18px;font-weight:900;color:var(--gold)">${p.sessions}</div>
        ...
        <div class="rcell">
          ...
          <div class="rico" style="font-size:14px;font-family:'Share Tech Mono',monospace;color:var(--gold)">213k</div>
